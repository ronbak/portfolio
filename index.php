...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    ...
    <body>
        ...
        <![endif]-->
            ...
            <header class="header" data-type="background" data-speed="2">
                <span>
                <div class="mainContainer">
                    ...
                    <div class="headerLeft"><img src="img/headerimage.png" alt="headerimage" /></div>
        ...
        <div>
             ...
             <section class="section showcase">
                ...
                <div class="row">
                    ...
                    <div class="box eight">
                        <div class="overlay">
                            <div class="txt">
                                <h2>Schildersbedrijf Chris Pronk</h2>
                            </div>
                        </div>
                    </div>
                    </a>
            ...
            <div class="contentclients">
             <section class="section ambition">
                <div class="mainContainer">
                    <h2>Ambitious</h2>
                    <p>
             ...
             <section class="section familiar">
                <div class="mainContainer">
